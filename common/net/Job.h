...
public:
    ...
    inline const uint32_t *nonce() const              { return reinterpret_cast<const uint32_t*>(m_blob + 19); }
    ...
    inline uint32_t *nonce()                          { return reinterpret_cast<uint32_t*>(m_blob + 19); }
...
#   endif
    ...
    static inline uint32_t *nonce(uint8_t *blob)   { return reinterpret_cast<uint32_t*>(blob + 19); }
